        ...
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-12 xl:col-span-4">
            ...
            <AuditTool onAudit={() => {
              setIsAuditing(true);
              setTimeout(() => {
                setResult({ score: 25, summary: "Riesgo Crítico.", findings: [{id:1, level:'critical', title:'Biometría', description:'Extracción facial detected.'}]});
                setIsAuditing(false);
              }, 2000);
            }} isAuditing={isAuditing} />
          </div>
          <div className="col-span-12 xl:col-span-8">
            {result && <ResultsOverview result={result} userTier={userTier} onExport={() => userTier === 'Pro' ? window.print() : setIsPaymentOpen(true)} />}
          </div>
        </div>
      </main>
