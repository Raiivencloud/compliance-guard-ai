...
export default function Header({ activeView, onViewChange, isLoggedIn, userTier, onLogin, onLogout, user }: HeaderProps) {
  const [showUserMenu, setShowUserMenu] = useState(false);
  const { t } = useTranslation();

  return (
    <header className="bg-white/80 backdrop-blur-md border-b border-slate-200 px-8 h-14 flex justify-between items-center fixed top-0 left-0 right-0 z-50 shrink-0 select-none shadow-sm no-print">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden lg:block text-left pr-1">
                ...
                <p className="text-[10px] font-black text-slate-900 mt-1">{user.displayName || 'Usuario'}</p>
              </div>
