  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-white rounded-[2.5rem] w-full max-w-md p-8 pt-12 text-center relative shadow-2xl">
        ...
        <p className="text-slate-500 text-sm mb-8">Desbloqueá el reporte legal completo al instante.</p>
        ...
        <div className="space-y-3 mb-8">
          ...
          <button onClick={() => window.open('https://wa.me/5492615000872')} className="w-full py-4 bg-emerald-500 text-white rounded-2xl font-bold flex items-center justify-center gap-3 hover:bg-emerald-600 transition-colors">
